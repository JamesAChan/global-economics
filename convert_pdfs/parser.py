...
def get_content_table(name_file):
    list1 = []
    list2 = []
    with open('C:/Users/AYB/ProjPdf/contents.json') as data_file:
...
filedir2 = 'C:/Users/AYB/ProjPdf/HTMLs/'
...
with open('C:/Users/AYB/ProjPdf/file_out.json', 'w') as outfile:
